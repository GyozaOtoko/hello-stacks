...
function App() {
  ...
  const checkInputIsEmpty = (value) => value?.trim() ? false : true;
    ...
    <div className="flex flex-col justify-center items-center h-screen gap-8">
      ...
      { 
        userData && (
          <div className="flex gap-4">
            ...
            />
            <button
              className="p-4 bg-indigo-500 rounded text-white disabled:bg-gray-200 hover:disabled:border-gray-200"
              onClick={submitMessage} 
              disabled={checkInputIsEmpty(message)}
            >
              Submit New Message
            </button>
          </div> 
      ...
      <div className="flex gap-4">
        ...
        <button
          ...
          disabled={checkInputIsEmpty(transactionId)}
        >
          Retrieve Message
        </button>
      </div>
